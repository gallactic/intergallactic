...
const Account = require('./intergallactic/account'),
  ...
  Transaction = require('./intergallactic/transaction/transaction'),
  Send = require('./intergallactic/transaction/send'),
  Bond = require('./intergallactic/transaction/bond'),
  Unbond = require('./intergallactic/transaction/Unbond'),
  Permission = require('./intergallactic/transaction/permission'),
  Call = require('./intergallactic/transaction/call');
...
class Intergallactic {
  constructor(option = {}) {
    ...
    this.Send = Send.bind(null, this);
    this.Bond = Bond.bind(null, this);
    this.Unbond = Unbond.bind(null, this);
    this.Permission = Permission.bind(null, this);
    this.Call = Call.bind(null, this);
    this.utils = getUtil();
